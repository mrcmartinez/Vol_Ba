            ...
            <table width="100%">
                ...
                ?>
                    <tr id="fila-<?php echo $asistencia->id_personal; ?>">
                        ...
                        <td><input type="checkbox" value="<?php echo $asistencia->id_personal; ?>" name="personal[]"
                                onclick=""></td>

                        <?php }else{
     ?>
                        <td><div class="check-color"><input type="checkbox" value="<?php echo $asistencia->id_personal; ?>" name="personal[]" checked
                                disabled onclick="" id="check1"><label for="check1">Asistencia</label></div></td>
                        <?php
} ?>
                    </tr>
                    <?php } ?>
